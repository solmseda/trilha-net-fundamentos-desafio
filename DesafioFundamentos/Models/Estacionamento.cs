    ...
    public class Estacionamento
    {
        ...
        public void AdicionarVeiculo()
        {
            ...
            do
            {
                ...
                placaValida = checarPlaca(placa);
                if (!placaValida)
                {
                    Console.WriteLine("Placa inválida. Digite uma placa no formato ABC1234:");
                }
            }
            while (!placaValida);
            veiculos.Add(placa);
        ...
        private bool checarPlaca(string placa)
        {
